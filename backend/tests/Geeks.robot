...
Be a geek
    ...
    Should Be Equal As Strings
    ...    ${user}[geek_profile][whatsapp]
    ...    ${response.json()}[whatsapp]
    Should Be Equal As Strings
    ...    ${user}[geek_profile][desc]
    ...    ${response.json()}[desc]
    Should Be Equal As Numbers
    ...    ${user}[geek_profile][cost]
    ...    ${response.json()}[cost]
    Should Be Equal As Strings
    ...    ${user}[geek_profile][printer_repair]
    ...    ${response.json()}[printer_repair]
    Should Be Equal As Strings
    ...    ${user}[geek_profile][work]
    ...    ${response.json()}[work]
    Should Be Equal As Strings
    ...    True
    ...    ${response.json()}[is_geek]
